	...
	if(FALSE == error)
	{
	    ...
	    ************************************************************************************/
            ...
            for(Pin_Index = 0; Pin_Index < PORT_CONFIGURED_PINS ;Pin_Index++)
            {
                ...
                /************************************************************************************
                 *                         EXCLUDE THE CONFIGURED PORT PINs                         *
                 ************************************************************************************/                 
                 
                  if(Port_Channels[Pin_Index].Pin_Dir_Changeable == DIR_UNCHANGEABLE)
                  {
                    continue;       /* Do Nothing ...  this pin direction should not be changed */
                  }
                  else
                  { 
...
void Port_SetPinMode(Port_PinType Pin, Port_PinModeType Mode)
{
  ...
  uint8 counter = 0;                            /* Local variable used as a counter for the PORTF PINs */
	...
	if (MODE_UNCHANGEABLE == Port_Channels[Pin].Pin_Mode)
	{
